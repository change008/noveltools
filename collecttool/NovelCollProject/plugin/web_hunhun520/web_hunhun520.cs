...
namespace NovelCollProject.plugin.web_hunhun520
{
    class Page : PageBase
    {
        ...
        {
            pageFeature.InjectUrlRule(PageTypeEnum.StartupPage, @"REG:hunhun520.com/book/\w+/$");
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:hunhun520.com/book/\w+/\?chapter=");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:hunhun520.com/book/\w+/\d+.html");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage2, @"REG:hunhun520.com/book/\w+/\d+_\d+.html");
        }
        ...
        internal override void DoChapterList(bool isUTF8)
        {
        ...
        protected override void parseHtmlString(string htmlstring, int bookId = 0)
        {
            ...
            switch (PageType)
            {
                ...
                case PageTypeEnum.DetailPage2:
                    ...
                    break;
                case PageTypeEnum.ChapterList:
                    FinalData = parseChapterList(document.DocumentNode);
                    break;
                case PageTypeEnum.ChapterDetail:
                    FinalData = parseChapterDetail(document.DocumentNode);
                    break;
            }
        }
        ...
        /// <returns></returns>
        private Hashtable parseChapterList(HtmlNode documentNode)
        {
            return parseListPage(documentNode);
        }

        private Hashtable parseChapterDetail(HtmlNode documentNode)
        {
            return parseDetailPage1(documentNode);
        }
