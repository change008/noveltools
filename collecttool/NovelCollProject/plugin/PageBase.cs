...
namespace NovelCollProject.plugin
{
    class PageBase
    {
        ...
        internal virtual void DoChapterList(bool isUTF8)
        {
            ...
            {
                //页面类型设置为章节列表页面
                PageType = PageTypeEnum.ChapterList;
        ...
        /// </summary>
        /// <param name="isUTF8"></param>
        internal virtual void DoChapterDetail(bool isUTF8)
        {
            InternalRealUrl = getRealUrl(InternalUrl);
            ...
            {
                //页面类型设置为章节neirong页面
                PageType = PageTypeEnum.ChapterDetail;
