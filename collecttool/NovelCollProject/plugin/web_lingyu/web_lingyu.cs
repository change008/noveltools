...
namespace NovelCollProject.plugin.web_lingyu
{
    class Page : PageBase
    {
        ...
        {
            pageFeature.InjectUrlRule(PageTypeEnum.StartupPage, @"REG:lingyu.org/w+/337699/nonono$");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:lingyu.org/\w+/\d+/\d+/\d+.html");
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:lingyu.org/\w+/\d+/\d+/\?chapterlist");
