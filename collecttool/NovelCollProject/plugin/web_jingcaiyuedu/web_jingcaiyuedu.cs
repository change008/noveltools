...
namespace NovelCollProject.plugin.web_jingcaiyuedu
{
    class Page : PageBase
    {
        ...
        private Hashtable parseListPage(HtmlNode documentNode)
        {
            ...
            Regex reg  ;
            Match m ;
            HtmlNodeCollection linkNodes = documentNode.SelectNodes("//div[@class='panel-body']/dl/dd");
            if (linkNodes != null)
            {
                ...
                foreach (var liNode in linkNodes)
                {
                    ...
                    if (string.IsNullOrEmpty(url))
                        continue;
                    if (url.Contains("187664/39.html")||url.Contains("187664/36.html")
                        || url.Contains("187664/79.html") || url.Contains("187664/81.html")
                        || url.Contains("187664/90.html") || url.Contains("187664/104.html")
                         || url.Contains("187664/271.html") || url.Contains("187664/312.html")
                         || url.Contains("187664/315.html"))
                    {
                    }
                    else {
                        continue;
