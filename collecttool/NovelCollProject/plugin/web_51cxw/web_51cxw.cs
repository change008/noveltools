...
namespace NovelCollProject.plugin.web_51cxw
{
    class Page : PageBase
    {
        ...
        {
            pageFeature.InjectUrlRule(PageTypeEnum.StartupPage, @"REG:51cxw.cn/w+/337699/nonono$");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:51cxw.cn/\w+/\d+.html");
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:51cxw.cn/\w+/\?chapterlist");
        ...
        private Hashtable parseDetailPage1(HtmlNode documentNode)
        {
            ...
            if (tempNode != null)
            {
                ...
                tempString = tempString.Replace("\r\n", "")
                    .Replace("\t", "")
                    .Replace("Δ", "").Replace("Ω", "").Replace("┡", "").Replace("』", "").Replace("『", "").Replace("ㄟ", "")
                    .Replace("＊", "").Replace("ん", "").Replace("┡", "").Replace("』", "").Replace("『", "").Replace("ㄟ", "")
                    .Replace("８⒈Ｚｗ．", "").Replace("．","")
                    .Replace("㈧", "").Replace("㈠", "").Replace("中文网", "").Replace("中文", "").Replace("文网", "")
                    ;
