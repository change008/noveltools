...
namespace NovelCollProject.plugin.web_kanshula
{
    class Page : PageBase
    {
        ...
        protected override void buildPageFeatureRules(PageFeature pageFeature)
        {
            ...
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:kanshula.com/\w+/\w+/\?chapterlist");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:kanshula.com/\w+/\w+/\d+.shtml");
