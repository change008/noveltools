...
namespace NovelCollProject.plugin.web_aoyo
{
    class Page : PageBase
    {
        ...
        protected override void buildPageFeatureRules(PageFeature pageFeature)
        {
            ...
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:aoyo.org/\w+/\d+.html\?chapterlist");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:aoyo.org/\d+/\d+_\d+.html");
        }
