...
namespace NovelCollProject.plugin.web_freexs
{
    class Page : PageBase
    {
        ...
        protected override void buildPageFeatureRules(PageFeature pageFeature)
        {
            ...
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:freexs.org/\w+/\d+/\d+/index.html\?chapterlist");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:freexs.org/\w+/\d+/\d+/\d+.html");
        }
