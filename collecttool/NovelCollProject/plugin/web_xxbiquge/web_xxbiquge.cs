...
namespace NovelCollProject.plugin.web_xxbiquge
{
    class Page : PageBase
    {
        ...
        protected override void buildPageFeatureRules(PageFeature pageFeature)
        {
            ...
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:xxbiquge.com/\d+_\d+/\?chapterlist");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:xxbiquge.com/\d+_\d+/\d+.html");
        }
