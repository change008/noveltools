...
namespace NovelCollProject
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        private string ConnectionString = "Database=novelCollection;Data Source=192.168.0.149;User Id=root;Password=tx123456;pooling=false;CharSet=utf8;port=3306";
