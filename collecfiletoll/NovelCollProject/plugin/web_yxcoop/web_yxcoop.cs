...
namespace NovelCollProject.plugin.web_yxcoop
{
    class Page : PageBase
    {
        ...
        {
            pageFeature.InjectUrlRule(PageTypeEnum.StartupPage, @"REG:yxcoop.com/\d+.shtml$");
           // pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:yxcoop.com/\d+.shtml\?chapter=");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:yxcoop.com/\d+/zhangjie\d+.shtml");
        ...
        private Hashtable parseStartupPage(HtmlNode documentNode)
        {
            ...
            HtmlNode linkNodes = documentNode.SelectSingleNode("//div[@class='wrapper']/h1/a");
            if (linkNodes != null)
            {
        ...
        private Hashtable parseListPage(HtmlNode documentNode)
        {
            ...
            Regex reg  ;
            Match m ;
            HtmlNodeCollection linkNodes = documentNode.SelectNodes("//ul[@class='nav clearfix']/span");
            if (linkNodes != null)
            {
