...
namespace NovelCollProject.plugin.web_ziyouge
{
    class Page : PageBase
    {
        ...
        private Hashtable parseStartupPage(HtmlNode documentNode)
        {
            ...
            HtmlNode linkNodes = documentNode.SelectSingleNode("//div[@class='title']/h1");
            ...
            linkNodes = documentNode.SelectSingleNode("//div[@id='text']");

            if (linkNodes != null)
            {
                var intro = linkNodes?.InnerText;
                ht.Add(CollectionFieldName.Novel_Intr, intro);
            }
