...
namespace NovelCollProject.plugin.web_bixia
{
    class Page : PageBase
    {
        ...
        {
            pageFeature.InjectUrlRule(PageTypeEnum.StartupPage, @"REG:bixia.org/\d+_\d+/$");
            pageFeature.InjectUrlRule(PageTypeEnum.ListPage1, @"REG:bixia.org/\d+_\d+/\?chapter=");
            pageFeature.InjectUrlRule(PageTypeEnum.DetailPage1, @"REG:bixia.org/\d+_\d+/\d+.html");
