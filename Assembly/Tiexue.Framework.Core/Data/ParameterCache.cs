...
// SQLHelper.cs
//
// This file contains the implementations of the   SqlHelperParameterCache class.
//
...
namespace Tiexue.Framework.Data
{
    public sealed class ParameterCache
    {
        ...
        public static SqlParameterDictionary ResolveSpParameters(string connectionString, string spName)
        {
            return new SqlParameterDictionary(GetSpParameterSet(connectionString, spName, false));
        }
